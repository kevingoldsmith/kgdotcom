...
def _generate_writing_metadata(metadata: PageMetadata, data: Optional[Dict], base_url: str, author: str) -> PageMetadata:
...
def _generate_resume_metadata(metadata: PageMetadata, data: Optional[Dict], base_url: str, author: str) -> PageMetadata:
...
def _generate_talks_metadata(metadata: PageMetadata, data: Optional[Dict], base_url: str, author: str) -> PageMetadata:
...
def _generate_music_metadata(metadata: PageMetadata, data: Optional[Dict], base_url: str, author: str) -> PageMetadata:
...
def _generate_photos_metadata(metadata: PageMetadata, data: Optional[Dict], base_url: str, author: str) -> PageMetadata:
...
def _generate_photo_metadata(metadata: PageMetadata, data: Optional[Dict], base_url: str, author: str) -> PageMetadata:
...
def _generate_index_metadata(metadata: PageMetadata, data: Optional[Dict], base_url: str, author: str) -> PageMetadata:
